package dev.onkar.productservice.thirdpartyclients.productservice.fakestore;
...
public class FakeStoreProductServiceClient  {
    ...
    public FakeStoreProductDto deleteProduct(Long id) {
        ...
        ResponseEntity<FakeStoreProductDto> response = restTemplate.execute(specificProductRequestUrl,
